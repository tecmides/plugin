...
class assign_rule_mining extends base_rule_mining
{
    ...
    {
        $rules = array_merge(
            (new assign_rule_mining_step1())->get_rules($minerator, $numRules),
            (new assign_rule_mining_step2())->get_rules($minerator, $numRules),
            (new assign_rule_mining_step3())->get_rules($minerator, $numRules)
        );
